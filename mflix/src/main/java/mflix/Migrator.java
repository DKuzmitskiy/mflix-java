...
public class Migrator {
  ...
  private static UpdateOneModel<Document> transformRating(Document doc) {
    try {
      ...
      return new UpdateOneModel<>(new Document("_id", doc.getObjectId("_id")),
  ...
  public static void main(String[] args) {
    ...
    String mongoUri = "mongodb+srv://m220student:m220password@mflix-rfmbm.mongodb.net/test?maxPoolSize=50";
